...
export const GoalIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const LightBulbIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
  ...
  >
    <path d="M9 21h6"></path>
    <path d="M12 21a9 9 0 0 0 9-9 9.75 9.75 0 0 0-6.74-9.98L12 3l-2.26-.02A9.75 9.75 0 0 0 3 12a9 9 0 0 0 9 9Z"></path>
  </svg>
);
...
export const SettingsIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
  ...
  >
    ...
    <path d="M12 1v6m0 12v6"></path>
    <path d="m20.49 9-1.714 1.714M3.51 15l1.714-1.714"></path>
    <path d="M20.49 15-1.714-1.714M3.51 9l1.714 1.714"></path>
  </svg>
);
